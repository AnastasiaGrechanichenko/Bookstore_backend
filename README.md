...
**Доступ:** `/admin`(локально: `http://127.0.0.1:8000/admin`)  
**Логин:** `admin`  
**Пароль:** из `.env` 

**Функции:**

- **Книги** – просмотр, создание, редактирование, удаление, поиск
- **Пользователи** – просмотр, редактирование, удаление
- **Заказы** – просмотр, редактирование, удаление
- **Корзина** – просмотр, редактирование, удаление
- **Избранное** – просмотр, удаление
...
```bash
git clone https://github.com/AnastasiaGrechanichenko/Bookstore_backend.git
